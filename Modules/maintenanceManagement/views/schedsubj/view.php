  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid ">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h2 class="m-0">View Subject Schedule</h2>
          </div><!-- /.col -->
          <div class="col-sm-6">
                ...
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="subject_id" id="subject_id" class="form-control" readonly>
                    ...
                    <div class="form-group">
                        ...
                        <select name="professor_id" id="professor_id" class="form-control" readonly>
                    ...
                    <div class="form-group">
                        ...
                        <select name="semester_id" id="semester_id" class="form-control" readonly>
                        ...
                        <select name="sy_id" id="sy_id" class="form-control" readonly>
                    ...
                    <div class="form-group">
                      ...
                      <select name="day" id="day" class="form-control" readonly>
                      ...
                      <select name="end_day" id="end_day" class="form-control" readonly>
                          <option selected disabled>-- Please Select Day --</option>
