            ...
            <div class="row">
              ...
              <div class="col-md-12">
                ...
                <div class="input-group mb-3">
                  <input type="text" class="form-control" value="<?=isset($value['lab_name']) ? esc($value['lab_name']): ''?>" placeholder="Lab Name" id="lab_name" name="lab_name" readonly>
                </div>
