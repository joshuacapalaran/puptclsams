  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid ">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h2 class="m-0">View Professor</h2>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" value="<?=isset($value['f_code']) ? esc($value['f_code']): ''?>" placeholder="Faculty Code" id="f_code" name="f_code" readonly>
                </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select class="form-control select" aria-label="Default select example" name="suffix_id" readonly disabled>
