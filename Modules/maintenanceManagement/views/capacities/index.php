          ...
          <div class="col-12">
            <div class="card card-outline card-secondary">
                      <div class="card-header">
                         <a href="<?=base_url('admin/capacities/add')?>" class="btn btn-sm btn-primary">+ Capacity</a>
                      </div>
                      <!-- /.card-header -->
                      <div class="card-body">
                            ...
                            <?php foreach($capacities as $capacity): ?>
                              <tr>
                                ...
                                <td>
                                  ...
                                  <?php else:?>
                                    <a class="btn btn-success btn-sm remove" onclick=" confirmUpdateStatus('<?= base_urL('admin/capacities/active/')?>',<?=$capacity['id']?>,'a')" title="activate">Restore</i></a>
                                  <?php endif;?>
                                </td>
                              </tr>
                              <?php $ctr++?>
