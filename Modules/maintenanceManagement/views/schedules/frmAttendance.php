            ...
            <div class="card">
                <div class="card-header">
                  ...
                  <div class="form-group col-md-6 offset-md-3">
                      ...
                      <span>  <?= $info['event_name'] ? 'Event: '.$info['event_name']:'Subject: '.$info['subj_code'].' - '.$info['subj_name']; ?> <br> Course: <?= $info['course_name']?><br> Section: <?= $info['year'].'-'.$info['section']?> <br> Date:  <?= $data['date']?> <br> Time: <?= $info['start_time']?> - <?=$info['end_time']?></span>
                      <br>
